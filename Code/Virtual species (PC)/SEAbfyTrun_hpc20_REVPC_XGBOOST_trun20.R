...
#Model run name
SDMalgo <- "XGBOOST" #"ANN","CTA","GLM","GBM","MARS","MAXNET","RF","XGBOOST"
datetime <- paste("bmod424_trunc_rev_",vtype,"vsp")
...
model.files.dir <- paste0("results_",datetime,"_",SDMalgo,"_",Trunarea,"_trun",TrunPrec,"perc")
dir.create(paste0("/lustre1/g/sbs_bonebrake/Eugene/SDMout/",model.files.dir)) 
species.list.dir <- paste0("species_list_",datetime,"_",SDMalgo,"_",Trunarea,"_trun",TrunPrec,"perc")
