...
#Model run name
datetime <- "bmod424_trunc_bio_phchndvi_rev"
...
current.climate <- current.climate[[c("WorldClim_bio01","WorldClim_bio04","WorldClim_bio05","WorldClim_bio06","WorldClim_bio12",
                                          "WorldClim_bio13","WorldClim_bio14","WorldClim_bio15","Canopy_Height","Soilgrids_soil_pH","NDVImean")]]
